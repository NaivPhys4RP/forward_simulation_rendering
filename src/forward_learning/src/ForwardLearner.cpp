...
class ForwardLearner : public DrawingAnnotator
{
private:
...
public:
  ...
  ForwardLearner(): DrawingAnnotator(__func__)
  {
    color=0;
  }
  ...
  {
    outInfo("initializing ForwardLearner");
  ...
  TyErrorId destroy()
  {
    outInfo("destroying ForwardLearner");
    return UIMA_ERR_NONE;
  }
  ...
  {
    MEASURE_TIME;
    outInfo("running ForwardLearner");
    return UIMA_ERR_NONE;
  }
