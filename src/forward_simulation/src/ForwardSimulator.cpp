...
class ForwardSimulator : public DrawingAnnotator
{
private:
...
public:
  ...
  ForwardSimulator(): DrawingAnnotator(__func__)
  {
    color=0;
  }
  ...
  {
    outInfo("initializing ForwardSimulator");
  ...
  TyErrorId destroy()
  {
    outInfo("destroying ForwardSimulator");
    return UIMA_ERR_NONE;
  }
  ...
  {
    MEASURE_TIME;
    outInfo("running ForwardSimulator");
    return UIMA_ERR_NONE;
  }
